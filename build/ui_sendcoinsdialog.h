...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 CART"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 CART"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 CART"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 CART"));
        ...
        labelBalance->setText(QStringLiteral("123.456 CART"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0.00 CART", 0));
