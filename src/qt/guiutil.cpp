...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Cart.lnk";
}
...
{
    return GetAutostartDir() / "Cart.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Cart-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Cart-qt [" + tr("command-line options") + "]                     " + "\n";
