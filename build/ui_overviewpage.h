...
""));
        ...
        labelBalance->setText(QStringLiteral("0 CART"));
        ...
        labelStake->setText(QStringLiteral("0 CART"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 CART"));
        ...
        labelImmature->setText(QStringLiteral("0 CART"));
        ...
        coinLogo->setPixmap(QPixmap(QString::fromUtf8(":/icons/logo_backg")));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Cart network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Cart network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
