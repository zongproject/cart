...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Cart", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Cart</b> version", 0));
...
"Copyright \302\251 2018 The Cart developers", 0));
